...
module.exports = exports = {
  ...
  handler: async (req, res) => {
    ...
    try {
      let Item = await global.models.GLOBAL.QUESTION.findById({ _id: id });
      ...
      if (!Item) {
        ...
        const checkQuestion = await global.models.GLOBAL.QUESTION.find({
          Sid: Sid,
          Qname: Qname,
          type: type,
        });
        ...
        Item = await global.models.GLOBAL.QUESTION.update(
          { _id: id },
          { $set: { Sid: Sid, Qname: Qname, Option: Option, type: type } }
        );
        const data4createResponseObject = {
          req: req,
          result: 0,
